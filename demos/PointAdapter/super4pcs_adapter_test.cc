...
int main(int argc, char **argv) {
  ...
  //
  // Convert the points to PointType1 to test adapter
  //
  std::vector<extlib1::PointType1> set1_points1 = getExtlib1Points(set1);
  std::vector<extlib1::PointType1> set2_points1 = getExtlib1Points(set2);
